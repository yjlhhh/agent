...
from schemas.message import FilestResponse , SessionListResponse, SessionResponse, DeleteFileRequest
...
async def get_messages_by_session_id(
    ...
    try:
        ...
        for message in messages_data:
            ...
            recommended_questions = [q.strip() for q in recommended_questions_str.split(",")] 
            messages.append(
                {
